 ...
 *
 * The Reviewer also holds the Administrator authority, so the administrative paths are
 * exercisable from the first run: without one, appointing the first Administrator would
 * be an Administrator-only act nobody could ever perform.
 */
