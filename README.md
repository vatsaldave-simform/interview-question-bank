...
password ends every session the Viewer had. A Viewer sent any link in the last five minutes
(`PASSWORD_RESET_MAIL_WINDOW_SECONDS`) is not mailed again, and the answer is still 202
(ADR-0040).
